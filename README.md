...
And [`conformance/`](conformance/) holds the vectors — **297 of them, in ten families** — that every
...
Physical design (placement map contract 5): [key order, ClickHouse partitions and index
